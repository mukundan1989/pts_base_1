...
// COPY THE COMPLETE LOOKUP TABLE FROM YOUR ORIGINAL lib.rs HERE
// Replace this section with the full const ADF_P_VALUE_LOOKUP from lines 6-50010 of your original lib.rs
const ADF_P_VALUE_LOOKUP: &[[f64; 2]] = &[
    [-4.98402287309096,0.00002],
    [-4.95836394213414,0.00004],
    [-4.92149631526284,0.00006],
    // ... PASTE ALL 50,000+ ENTRIES FROM YOUR ORIGINAL lib.rs HERE ...
    [2.32967629028527,0.99998],
...
pub fn calculate_complete_adf_test(data: Vec<f64>, model_type: &str) -> CompleteAdfResult {
    let _n = data.len(); // Fixed unused variable warning
    if data.len() < 5 {
